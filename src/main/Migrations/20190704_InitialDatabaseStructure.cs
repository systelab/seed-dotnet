    ...
    public class InitialDatabaseStructure : Migration
    {
        public override void Up()
        {
            ...
            if (!this.Schema.Table(patientAllergiesTableName).Exists())
            {
                ...
                this.Create.PrimaryKey("PK_PatientAllergies").OnTable(patientAllergiesTableName).Columns(new[] { "IdAllergy", "IdPatient" });
            }
            ...
            if (!this.Schema.Table(aspNetUserLoginsTableName).Exists())
            {
                ...
                this.Create.PrimaryKey("PK_AspNetUserClaims").OnTable(aspNetUserLoginsTableName).Columns(new[] { "LoginProvider", "ProviderKey" });
            }
            ...
            if (!this.Schema.Table(aspNetUserRolesTableName).Exists())
            {
                ...
                this.Create.PrimaryKey("PK_AspNetUserRoles").OnTable(aspNetUserRolesTableName).Columns(new[] { "UserId", "RoleId" });
            }
            ...
            if (!this.Schema.Table(aspNetUserTokensTableName).Exists())
            {
                ...
                this.Create.PrimaryKey("PK_AspNetUserTokens").OnTable(aspNetUserTokensTableName).Columns(new[] { "UserId", "LoginProvider", "Name" });
            }
        }
